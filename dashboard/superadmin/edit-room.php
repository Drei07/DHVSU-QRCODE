...
$pdoQuery = "SELECT * FROM location WHERE Id =" . $_GET['id'];
		...
		<main>
            ...
            <section class="data-form">
				...
				<div class="registration">
					<form action="controller/update-room-controller.php?Id=<?php echo $locationId ?>" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()"  novalidate style="overflow: hidden;">
						<div class="row gx-5 needs-validation">

							<div class="col-md-12">
								<label for="acdemic" class="form-label">Academic Program<span> *</span></label>
								<input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" value="<?php echo $location_name ?>" autocapitalize="on"  autocomplete="off" name="room" id="room" required>
