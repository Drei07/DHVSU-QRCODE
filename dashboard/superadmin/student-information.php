...
$pdoQuery = "SELECT * FROM student WHERE studentId = :id";
	...
	<section id="content">
		...
		<main>
            ...
            <ul class="breadcrumbs">
				...
				<li class="divider">|</li>
				<li><a href="room-records?Id=<?php echo $roomId ?>">Room Records</a></li>
				<li class="divider">|</li>
				...
				<div class="profile">
					...
					<div id="information"> 
						<form action="controller/update-student-data-controller.php?id=<?php echo $student_Id ?>" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()"  novalidate style="overflow: hidden;">
							...
							<div class="addBtn">
								<button type="button" onclick="location.href='room-records?Id=<?php echo $roomId ?>'" class="back">Back</button>
							</div>
						</form>
					</div>
