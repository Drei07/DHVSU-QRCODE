					...
					<form action="controller/add-programs-controller.php" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()"  novalidate style="overflow: hidden;">
						<div class="row gx-5 needs-validation">
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control" autocapitalize="on"  autocomplete="off" name="AProgram" id="acdemic" required>
							...
							<div class="col-md-6">
								<label for="acronym" class="form-label">Acronym<span> *</span></label>
								<input type="text" class="form-control" autocapitalize="on"  autocomplete="off" name="Acronym" id="acronym" required>
								<div class="invalid-feedback">
