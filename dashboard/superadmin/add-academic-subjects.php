		...
		<nav>
			...
			<div class="profile">
				...
				<ul class="profile-link">
					...
					<li><a href="notification"><i class='bx bxs-bell icon' ></i> Notifications</a></li><span class="badge">5</span>
				...
				<div class="registration">
					<form action="controller/add-academic-subject-controller?id=<?php echo $subject ?>" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()"  novalidate style="overflow: hidden;">
                        ...
                        <div class="col-md-6">
							...
							<div class="col-md-6">
								<label for="subject_code" class="form-label">Subject Code<span> *</span></label>
								<input type="text" class="form-control" autocapitalize="on"  autocomplete="off" name="SCode" id="subject_code"  required >
								<div class="invalid-feedback">
